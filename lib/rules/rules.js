...
/**
 * @typedef {import('../../../lib/jsdoc/types.js').RulesResponse} RulesResponse
 */
 ...
 * @return {Promise<RulesResponse>} - a promise that, when successful, will resolve with the league's rules data as an object.
 */
